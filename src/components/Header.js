 ...
 const remove = (item)=>{
  ...
  return (
    ...
    <Navbar expand="lg" variant="light">
        <Container>
        <Navbar.Brand href="#home"  className="newFont text-decoration-none text-light mx-3 mt-3">AZCart</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto mx-5">
            <NavLink to="/" className="text-decoration-none text-light align_home" style={{fontSize:20}}>Home</NavLink>
          </Nav>
