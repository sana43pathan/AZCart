  ...
  //   console.log(CardsData);
    ...
    return (
                ...
                <div className="itemsdetails">
          {
            ...
            <p style={{fontSize:18,fontWeight:500}}>{ele.rname}</p>
              <Table>
                <tr>
                  <td>
              ...
              <div className='button_div d-flex justify-content-center'>
                      ...
                      <i className="fa fa-shopping-cart" style={{fontSize:20}} aria-hidden="true"></i><span className='mx-1'>Add to Cart</span></Button>
                    </div>
